...
export const crustFormationArticle: LearnArticleData = {
    ...
    subtitle: "How heat, moisture and Maillard reactions shape crust texture and color.",
    ...
    practicalRanges: [
        { label: "Surface Drying Threshold", notes: "Recommended: 90°C (Range: 80-100°C)" },
        { label: "Optimal Browning Start", notes: "Recommended: 150°C (Range: 140-160°C)" }
    ],
    ...
    grandmaVersion: {
        ...
        whatItDoes: "Makes the pizza crunchy and tasty.",
        howToUse: "The heat removes moisture and browns the surface.",
        dangerSigns: "Too little heat leaves it pale, too much burns it."
    }
};
