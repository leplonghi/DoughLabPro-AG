                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    <div>
                        ...
                        <input
                            ...
                            className="block w-full rounded-xl border border-dlp-border bg-dlp-bg-muted shadow-sm focus:border-dlp-primary focus:ring-dlp-primary sm:text-sm py-2.5 px-3 text-dlp-text-primary placeholder-dlp-text-muted"
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        <div>
                            ...
                            <select
                                ...
                                value={formData.type}
                                onChange={handleChange}
                                className="block w-full rounded-xl border border-dlp-border bg-dlp-bg-muted shadow-sm focus:border-dlp-primary focus:ring-dlp-primary sm:text-sm py-2.5 px-3 text-dlp-text-primary"
                            >
                    ...
                    <div className="flex gap-6 p-3 bg-dlp-bg-muted rounded-xl border border-dlp-border">
                        <div className="flex items-center">
                            <input
                                ...
                                onChange={handleChange}
                                className="h-5 w-5 rounded border border-dlp-border text-dlp-primary focus:ring-dlp-primary"
                            />
                    ...
                    <div className="pt-4 flex justify-end gap-3 border-t border-dlp-border">
                        ...
                        <button
                            type="submit"
                            className="rounded-xl bg-dlp-primary px-5 py-2.5 text-sm font-bold text-white shadow-dlp-lg shadow-dlp-primary/20 hover:bg-dlp-primary-hover transition-all"
                        >
                            {t('common.save')}
                        </button>
                    </div>
