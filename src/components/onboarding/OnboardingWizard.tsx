            ...
            render: () => (
                <div className="text-center space-y-6">
                    ...
                    <div className="pt-4">
                        <button
                            onClick={() => setStep(1)}
                            className="w-full bg-dlp-primary-hover text-white py-3 px-6 rounded-lg font-semibold shadow-lg hover:bg-lime-700 transition flex items-center justify-center gap-2"
                        >
        ...
        // Step 1: Persona & Interest
        {
            ...
            render: () => (
                <div className="space-y-6">
                                ...
                                {(['beginner', 'intermediate', 'advanced'] as const).map((l) => (
                                    <button
                                        ...
                                        className={`p-3 rounded-lg border text-sm font-medium transition-all ${skill === l
                                            ? 'border-dlp-primary bg-lime-50 text-lime-700 ring-1 ring-dlp-primary'
                    ...
                    <button
                        onClick={() => setStep(2)}
                        className="w-full mt-4 bg-dlp-primary-hover text-white py-3 rounded-lg font-semibold hover:bg-lime-700 transition"
                    >
            ...
            render: () => (
                <div className="space-y-6">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="w-full bg-dlp-primary-hover text-white py-3 rounded-lg font-semibold hover:bg-green-700 transition shadow-lg flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {isLoading ? (
                            <>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
            ...
            >
                ...
                <div className="h-1 bg-slate-100 w-full">
                    <motion.div
                        className="h-full bg-dlp-primary"
                        initial={{ width: '0%' }}
