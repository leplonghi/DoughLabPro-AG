...
export const DashboardFooter: React.FC<DashboardFooterProps> = ({ onSave }) => {
    ...
    return (
        <div className="sticky bottom-0 left-0 right-0 bg-white/80 dark:bg-white/80 backdrop-blur-md border-t border-slate-200 dark:border-slate-200 p-4 z-50">
            <div className="max-w-3xl mx-auto flex items-center justify-between gap-4">
                ...
                >
                    <Save size={18} />{t('common:save_to_my_labs')}</button>
            </div>
        </div>
    );
};
