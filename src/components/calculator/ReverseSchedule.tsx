        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                    ...
                    <button
                        ...
                        className={`p-3 rounded-lg transition-colors min-h-[44px] min-w-[44px] ${notificationsEnabled ? 'bg-amber-100 text-amber-600' : 'bg-slate-100 text-slate-400 hover:text-slate-600'}`}
                    >
                    ...
                    <input
                        ...
                        className="flex-1 sm:flex-none border border-slate-300 rounded-lg px-3 py-2.5 text-sm font-medium text-slate-700 bg-slate-50 focus:ring-2 focus:ring-amber-500 focus:outline-none min-h-[44px]"
                    />
                </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-slate-100">
                <button
                    ...
                    className="w-full flex items-center justify-center gap-2 text-sm font-medium text-amber-700 hover:bg-amber-50 py-3 rounded-lg transition min-h-[44px]"
                >
