        ...
        <div className={`rounded-3xl border border-slate-200 bg-white shadow-sm overflow-hidden ${className}`}>
            ...
            >
                <div className="flex items-center gap-4">
                    <div className="p-2 bg-white rounded-xl border border-slate-100 shadow-sm text-dlp-primary-hover">
                ...
                <div className="p-5 border-t border-slate-100 bg-white animate-fade-in">
                    ...
                    <div className="flex justify-end pt-2 border-t border-slate-50">
                        <a
                            ...
                            className="text-xs font-bold text-dlp-primary-hover hover:text-lime-700 flex items-center gap-1"
                        >
