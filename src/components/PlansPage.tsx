    ...
    return (
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 animate-[fadeIn_0.5s_ease-in-out]">
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold tracking-tight text-dlp-text-primary sm:text-5xl">
                    Choose Your Plan
                </h1>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12 max-w-5xl mx-auto">
                ...
                <div className="rounded-2xl border border-dlp-border bg-dlp-bg-card p-8 shadow-dlp-sm hover:shadow-dlp-md transition-shadow">
                    <h2 className="text-2xl font-bold text-dlp-text-primary">Free</h2>
                    <p className="mt-2 text-dlp-text-muted">Essential tools for home bakers.</p>
                    <p className="mt-8 text-4xl font-bold text-dlp-text-primary">$0</p>
                    <p className="text-sm text-dlp-text-muted">Forever free</p>
                ...
                <div className="relative rounded-2xl border-2 border-dlp-accent bg-dlp-bg-card p-8 shadow-dlp-lg">
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 rounded-full bg-dlp-accent px-4 py-1 text-sm font-bold text-white uppercase tracking-wide">
                        Most Popular
                    </div>
                    <h2 className="text-2xl font-bold text-dlp-text-primary flex items-center gap-2">
                        Pro
                        <SparklesIcon className="h-6 w-6 text-dlp-accent" />
                    </h2>
                    <p className="mt-2 text-dlp-text-muted">Advanced tools for serious pizza makers.</p>
