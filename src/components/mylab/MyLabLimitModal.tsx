                            ...
                            <Dialog.Panel className="relative transform overflow-hidden rounded-2xl bg-dlp-bg-card text-left shadow-dlp-lg transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                ...
                                <div className="px-6 pb-8 pt-2 text-center">
                                    ...
                                    <div className="space-y-3">
                                        <button
                                            type="button"
                                            className="group relative flex w-full items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-dlp-primary-hover to-dlp-primary py-4 px-6 text-base font-bold text-white shadow-lg shadow-dlp-primary/30 hover:shadow-xl hover:from-dlp-primary hover:to-lime-400 hover:-translate-y-0.5 transition-all"
