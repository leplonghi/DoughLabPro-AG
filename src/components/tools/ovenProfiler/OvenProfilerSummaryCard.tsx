    ...
    return (
        <div className="rounded-2xl bg-white p-8 shadow-lg border border-slate-200">
            <div className="flex items-start justify-between">
                <div>
                    <span className="inline-flex items-center gap-1 rounded-full bg-dlp-primary px-3 py-1 text-xs font-bold text-white uppercase tracking-wider mb-4">
                        {analysis.category}
                    </span>
                ...
                <div className="hidden sm:block p-3 bg-lime-50 rounded-full">
                    <CheckCircleIcon className="h-8 w-8 text-dlp-primary" />
                </div>
            </div>
        </div>
    );
