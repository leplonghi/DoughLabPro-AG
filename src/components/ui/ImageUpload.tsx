                ...
                >
                    ...
                    {uploading && (
                        <div className="absolute inset-0 bg-white/80 flex items-center justify-center z-10">
                            <SpinnerIcon className="w-6 h-6 text-dlp-primary-hover animate-spin" />
                        </div>
                    )}
                </div>
                ...
                {circle && (
                    <div className="flex flex-col gap-2">
                        <button
                            ...
                            onClick={triggerUpload}
                            disabled={uploading}
                            className="text-sm font-medium text-dlp-primary-hover hover:text-lime-700 border border-lime-200 bg-lime-50 hover:bg-lime-100 px-3 py-1.5 rounded-lg transition-colors flex items-center gap-2"
                        >
