    ...
    return (
        <div className="rounded-2xl bg-white p-6 shadow-sm border border-slate-200">
            <div className="flex items-center gap-3 mb-4">
                <div className="h-10 w-10 rounded-full bg-lime-100 flex items-center justify-center text-dlp-primary-hover">
            ...
            <button
                ...
                className="w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-br from-dlp-primary to-lime-700 py-3 text-sm font-bold text-white shadow-lg shadow-lime-900/10 hover:from-dlp-primary-hover hover:to-lime-800 transition-all active:scale-95"
