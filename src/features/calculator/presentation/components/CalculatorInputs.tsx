...
export const CalculatorInputs: React.FC = () => {
    ...
    return (
        <div className="calculator-inputs-demo p-6 bg-slate-50 rounded-xl border border-slate-200">
            <h3 className="text-xl font-bold text-slate-800 mb-4">{t('common:lab_engine_core')}</h3>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">

                {/* Flour Input */}
                <div className="form-group">
                    <label className="block text-sm font-medium text-slate-700 mb-1">{t('common:total_flour_g')}</label>
                    <input
                        type="text"
                        inputMode="decimal"
                ...
                <div className="form-group">
                    ...
                    <div className="relative">
                        ...
                        />
                        <div className="absolute right-3 top-2 text-xs text-slate-400">{t('common:locks_water')}</div>
                    </div>
                </div>

                {/* Water Input - Controls Hydration */}
                <div className="form-group">
                    <label className="block text-sm font-medium text-slate-700 mb-1">{t('common:water_g')}</label>
                    <div className="relative">
                        <input
                            type="text"
                            inputMode="decimal"
            ...
            <div className="mt-6 p-4 bg-slate-100 rounded text-xs font-mono text-slate-600">
                <p><strong>{t('common:debug_state_single_source_of_truth')}</strong></p>
