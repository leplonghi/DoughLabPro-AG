    ...
    return (
        <div className="p-4 bg-zinc-900 rounded-xl border border-zinc-800 mb-6">
            <textarea
                ...
                className="w-full bg-zinc-950 border border-zinc-800 rounded-lg p-3 text-zinc-200 focus:border-dlp-primary outline-none resize-none h-24 mb-3"
            />
            <div className="flex justify-end">
                <button
                    onClick={handlePost}
                    disabled={isPosting || !text.trim()}
                    className="px-4 py-2 bg-dlp-primary text-black font-bold rounded-lg hover:bg-lime-400 disabled:opacity-50"
                >
