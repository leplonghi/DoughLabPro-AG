  ...
  const { t } = useTranslation();
    ...
    if (!affiliateCode) {
        return (
            <div className="p-8 text-center bg-zinc-900 rounded-xl border border-zinc-800">
                ...
                <button className="px-6 py-3 bg-dlp-primary text-black font-bold rounded-xl hover:bg-lime-400">{t('marketing.join_program')}</button>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6">
            <div className="bg-gradient-to-r from-lime-900/40 to-zinc-900 border border-dlp-primary/20 rounded-xl p-6">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <button className="p-4 bg-zinc-950 rounded-lg border border-zinc-800 hover:border-dlp-primary/50 transition-colors text-left">
