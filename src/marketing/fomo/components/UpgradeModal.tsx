  ...
  const { t } = useTranslation();
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-zinc-900 border border-dlp-primary/30 rounded-2xl max-w-md w-full p-6 shadow-2xl relative overflow-hidden">
                {/* Decorative background effects */}
                <div className="absolute top-0 right-0 w-32 h-32 bg-dlp-primary/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
                ...
                <div className="relative z-10">
                    <div className="text-center mb-6">
                        <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-dlp-primary/20 text-lime-400 mb-4">
                    ...
                    <div className="space-y-3">
                        <button
                            ...
                            className="w-full py-3 px-4 bg-gradient-to-r from-dlp-primary to-dlp-primary-hover hover:from-lime-400 hover:to-dlp-primary text-black font-bold rounded-xl transition-all transform hover:scale-[1.02] shadow-lg shadow-lime-900/20"
                        >
                            {trigger.cta}
                        </button>
                        <button
