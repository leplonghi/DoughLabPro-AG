    ...
    return (
        <div className={`relative group overflow-hidden rounded-xl ${className}`}>
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10 bg-dlp-bg/40 backdrop-blur-[1px]">
                ...
                >
                    <div className="w-8 h-8 bg-dlp-primary/10 text-dlp-primary rounded-full flex items-center justify-center mb-2">
                    ...
                    <button className="mt-2 text-[10px] font-bold uppercase tracking-wider bg-dlp-primary hover:bg-dlp-primary-hover text-white px-3 py-1.5 rounded-full transition-colors shadow-dlp-sm">{t('marketing.unlock')}</button>
                </div>
            </div>
        </div>
    );
