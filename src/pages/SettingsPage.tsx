...
const ChoiceButton: React.FC<{
  ...
  <button
    type="button"
    onClick={onClick}
    className={`w-full rounded-lg px-4 py-2 text-center text-sm font-medium transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-dlp-primary focus:ring-offset-2 ${active
      ? 'bg-dlp-primary text-white font-semibold shadow-md'
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="block w-32 rounded-lg border-slate-300 shadow-sm focus:border-dlp-primary focus:ring-dlp-primary sm:text-sm p-2.5 border"
                  />
          ...
          <div className="border-t border-slate-200 pt-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="text-sm text-dlp-primary-hover hover:text-lime-700 font-medium transition-colors"
              >
                {t('common.manage')}
              </button>
            </div>
            ...
            {ovens.length === 0 ? (
              <div className="text-center py-8 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <button
                  onClick={() => navigate('/profile')}
                  className="mt-3 text-sm text-dlp-primary-hover hover:text-lime-700 font-medium"
                >
                  ...
                  >
                    ...
                    <div className="flex items-start gap-3">
                      <div className="p-2 bg-white rounded-lg border border-slate-200">
                        <FireIcon className="h-5 w-5 text-dlp-primary-hover" />
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <button
                          ...
                          className="mt-3 w-full flex items-center justify-center gap-1.5 rounded-lg bg-dlp-primary px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-dlp-primary hover:text-white-hover transition-colors"
                        >
