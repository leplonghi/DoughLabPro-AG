...
const CookiesPage: React.FC = () => {
  return (
    <LegalPageLayout title="Cookie Policy" lastUpdated="August 1, 2024">
      ...
      <ul className="list-disc pl-5 space-y-1">
        <li>
          <strong>Google Analytics:</strong> This site uses Google Analytics which is one of the most widespread and trusted analytics solutions on the web for helping us to understand how you use the site and ways that we can improve your experience. These cookies may track things such as how long you spend on the site and the pages that you visit so we can continue to produce engaging content.
        </li>
      </ul>
