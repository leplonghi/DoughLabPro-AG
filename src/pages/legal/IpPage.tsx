...
const IpPage: React.FC = () => {
  return (
    <LegalPageLayout title="Intellectual Property" lastUpdated="August 1, 2024">
      ...
      <p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, you must submit your notice in writing to the attention of "Copyright Infringement" at legal@doughlabpro.com and include in your notice a detailed description of the alleged Infringement.</p>
    </LegalPageLayout>
  );
};
