  ...
  return (
    <div className="mx-auto max-w-4xl animate-fade-in">
      ...
      <div className="text-center">
        <FlourIcon className="mx-auto h-12 w-12 text-dlp-primary" />
          ...
          return (
            <div
              ...
              className={`rounded-2xl border bg-white  shadow-md transition-all ${isPreferred
                ? 'border-dlp-primary ring-2 ring-dlp-primary/50 '
                : 'border-slate-200 '
                }`}
            >
              <div className="p-6">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm font-semibold text-dlp-primary-hover  capitalize">
              ...
              <div className="rounded-b-2xl border-t border-slate-200  bg-slate-50  p-4">
                <button
                  ...
                  className="w-full rounded-xl bg-dlp-primary py-3 px-4 text-sm font-bold text-white shadow-lg shadow-dlp-primary/20 transition-all hover:bg-dlp-primary hover:text-white-hover hover:scale-[1.02] active:scale-[0.98] disabled:cursor-not-allowed disabled:bg-slate-300 disabled:shadow-none disabled:hover:scale-100"
                >
      ...
      <div className="mt-8 text-center">
        <button
          ...
          className="text-sm font-bold text-dlp-primary-hover  hover:underline"
        >
