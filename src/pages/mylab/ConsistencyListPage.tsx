                                ...
                                {sortedSeries.map(series => (
                                    <div key={series.id} className="rounded-2xl bg-white  p-6 border border-slate-200  shadow-sm hover:shadow-md transition-all">
                                        <div className="flex justify-between items-start">
                                            ...
                                            <button onClick={() => onNavigate(`mylab/consistency/${series.id}`)} className="text-sm font-bold text-dlp-primary-hover  hover:underline uppercase tracking-wider">{t('mylab.view_details')}</button>
                                        </div>
