                        ...
                        <>
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`
                                                    ...
                                                    ${isSelected
                                                        ? 'border-dlp-primary bg-lime-50 ring-2 ring-dlp-primary ring-offset-2'
                                            ...
                                            >
                                                <div className="flex items-start justify-between mb-2">
                                                    ...
                                                    {isSelected && <CheckCircleIcon className="w-6 h-6 text-dlp-primary-hover" />}
                                                </div>
                            ...
                            <div className={`fixed bottom-8 left-1/2 transform -translate-x-1/2 transition-all duration-300 ${selectedBatchIds.length >= 2 ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
                                <button
                                    ...
                                    className="flex items-center gap-2 bg-dlp-primary-hover hover:bg-dlp-primary hover:text-white text-white px-8 py-3 rounded-full shadow-xl font-bold text-lg transition-colors"
                                >
