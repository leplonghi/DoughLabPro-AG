                                ...
                                <div key={batch.id} className="bg-white  p-6 rounded-2xl border border-slate-200  shadow-sm hover:shadow-md transition-shadow">
                                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                                        <div>
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <span className="text-xs font-bold uppercase text-dlp-primary-hover tracking-wider">
                                    ...
                                    <div className="flex justify-end">
                                        <button
                                            ...
                                            className="text-sm font-semibold text-slate-500 hover:text-dlp-primary-hover flex items-center gap-1 transition-colors"
