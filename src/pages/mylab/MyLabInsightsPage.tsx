        ...
        <MyLabLayout activePage="mylab/insights" onNavigate={onNavigate}>
            <div className="animate-fade-in pb-20">
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-slate-600 ">{t('ui:analyze_patterns_and_trends_in_your_baking')}</p>
                </div>
                <LockFeature
                ...
                >
                    {!stats ? (
                        <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
                            ...
                            <p className="text-slate-500 mt-2 max-w-sm mx-auto">{t('ui:complete_at_least_one_batch_to_generate_insights')}</p>
                            <button
