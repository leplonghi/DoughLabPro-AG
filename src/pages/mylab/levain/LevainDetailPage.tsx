        ...
        return (
            <MyLabLayout activePage="mylab/levain" onNavigate={onNavigate}>
                <AppSurface className="p-8 text-center">
                    ...
                    <button onClick={() => onNavigate('mylab/levain')} className="mt-4 text-dlp-primary-hover  hover:underline">{t('mylab.back_to_list')}</button>
                </AppSurface>
            </MyLabLayout>
        );
    }
        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <AppSurface className="relative flex flex-col items-center overflow-hidden border-slate-200 p-6 text-center">
                ...
                <div className="w-full max-w-xs mt-6">
                    ...
                    <div className="h-3 w-full bg-slate-100  rounded-full overflow-hidden ring-1 ring-slate-200 ">
                        <div
                            className={`h-full transition-all duration-1000 ease-out ${stats.healthScore > 50 ? 'bg-dlp-primary' : stats.healthScore > 20 ? 'bg-amber-500' : 'bg-red-500'}`}
                ...
                <div className="mt-8 w-full flex flex-col sm:flex-row gap-3 justify-center">
                    <button
                        ...
                        className="flex items-center justify-center gap-2 rounded-xl bg-dlp-primary py-3 px-8 font-bold text-white shadow-lg shadow-dlp-primary/20 transition-all hover:bg-dlp-primary hover:text-white-hover hover:scale-105 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-dlp-primary focus-visible:ring-offset-2"
                    >
            ...
            <AppSurface className="mt-6 border-slate-200 p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-4 flex items-center gap-2">
                    <BookOpenIcon className="h-5 w-5 text-dlp-primary" />{t('mylab.learn_about_levain_behavior')}</h3>
                    ...
                    {[
                        ...
                        return (
                            <a
                                ...
                                className="block p-4 bg-slate-50 rounded-xl border border-slate-200 hover:border-dlp-primary hover:shadow-md transition-all group"
                            >
                                <h4 className="font-bold text-slate-800 group-hover:text-dlp-primary-hover transition-colors mb-2 line-clamp-1">
                                    {article.title}
                                </h4>
                            ...
                            <>
                                ...
                                {levain.feedingHistory.length > 3 && (
                                    <div className="p-6 text-center bg-gradient-to-b from-slate-50 to-white   rounded-2xl border border-dashed border-lime-200  mt-6">
                                        <div className="flex justify-center mb-3 text-dlp-primary-hover ">
                                        ...
                                        <button
                                            ...
                                            className="mt-3 inline-flex items-center gap-2 text-xs font-bold text-white bg-dlp-primary px-5 py-2.5 rounded-full hover:bg-dlp-primary hover:text-white-hover shadow-lg shadow-dlp-primary/20 transition-transform hover:scale-105 active:scale-95"
                                        >
