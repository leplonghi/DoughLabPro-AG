...
const ChemistryLibraryPage: React.FC = () => {
    return (
        <TechnicalPageLayout title="Pizza Chemistry Library" showReferencesSection>
            ...
            <LearnSection title="1. Hydration & Solubilization" icon={<BeakerIcon className="h-5 w-5" />}>
            ...
            <LearnSection title="4. Maillard Reaction" icon={<FireIcon className="h-5 w-5" />}>
            ...
            <LearnSection title="5. Caramelization">
            ...
            <LearnSection title="6. Starch Gelatinization">
            ...
            <LearnSection title="9. Thermal Degradation of Herbs and Aromas">
