...
const CheesesPage: React.FC = () => {
  return (
    ...
    >
      <LearnSection title="Introduction: The Sensitive Chemistry of Cheese">
        <p>
      ...
      <LearnSection title="Chemical Fundamentals of Cheese Behavior" icon={<BeakerIcon className="h-5 w-5" />}>
        <ul className="list-disc pl-5 mt-2 space-y-1">
      ...
      <LearnSection title="Technical Properties of Common Cheeses">
      ...
      <LearnSection title="The Oil-Out Phenomenon" icon={<BeakerIcon className="h-5 w-5" />}>
      ...
      <LearnSection title="Browning: Maillard Reaction in Cheese" icon={<FireIcon className="h-5 w-5" />}>
      ...
      <LearnSection title="Classic and Documented Blends" icon={<BookOpenIcon className="h-5 w-5" />}>
        <ul className="list-disc pl-5 mt-2 space-y-1">
      ...
      <LearnSection title="Risks and Practical Care">
        <ul className="list-disc pl-5 mt-2 space-y-1">
