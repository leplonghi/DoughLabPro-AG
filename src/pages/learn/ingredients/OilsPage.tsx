    ...
    >
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2">
        <button
          ...
          className="group block rounded-xl border border-slate-200 p-6 hover:border-dlp-primary hover:shadow-md transition-all text-left w-full"
        >
          <div className="flex items-center gap-3 mb-2">
            <div className="rounded-lg bg-lime-100 p-2 text-lime-700 group-hover:bg-dlp-primary group-hover:text-white transition-colors">
