                ...
                <AppSurface className="mb-8 p-5">
                    <div className="relative">
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-3 rounded-full border border-slate-200 focus:border-dlp-primary focus:ring-2 focus:ring-lime-200 outline-none transition-all"
                        />
                                    ...
                                    {articles.map(article => (
                                        <div key={article.id} className="p-6 hover:bg-slate-50 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-4 group">
                                            ...
                                            <button
                                                ...
                                                className="shrink-0 px-4 py-2 bg-white border border-slate-200 text-slate-700 font-bold text-sm rounded-lg hover:border-dlp-primary hover:text-dlp-primary-hover transition-all shadow-sm"
