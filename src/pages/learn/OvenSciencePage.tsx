...
const OvenSciencePage: React.FC = () => {
  ...
  return (
    <TechnicalPageLayout title={t('learn.baking_pizza_the_physics_of_the_oven')} showReferencesSection>
        ...
        <LearnSection title="2. Heat Flow: The Three Mechanisms">
            <p>
        ...
        <LearnSection title="3. Conduction: Base Heat">
            <p>
        ...
        <LearnSection title="4. Radiation: Top Heat">
            <p>
        ...
        <LearnSection title="5. Convection: Moving Air">
            <p>
        ...
        <LearnSection title="6. Phase Change: The Power of Steam">
            <p>
        ...
        <LearnSection title="7. Baking Stages">
            <p>
        ...
        <LearnSection title="8. Interaction with Ingredients">
            <p>
        ...
        <LearnSection title="9. Risks: Thermal Imbalance">
            <ul className="list-disc pl-5 mt-2 space-y-1">
