                ...
                <div className="bg-gradient-to-br from-[#3A6B3A] to-[#558B55] rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden">
                    ...
                    <div className="relative z-10 text-center max-w-3xl mx-auto">
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-2 bg-lime-500 hover:bg-lime-400 text-white font-bold py-2.5 px-6 rounded-full transition-all transform hover:scale-105 shadow-lg shadow-lime-900/20 text-sm"
                        >
                            <BookOpenIcon className="w-4 h-4" />
