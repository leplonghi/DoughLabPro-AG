...
import { SignalIcon, BeakerIcon, CubeIcon, FermentationIcon, WaterIcon, SaltIcon, OilIcon } from '@/components/ui/Icons';
...
const FundamentalsPage: React.FC<FundamentalsPageProps> = ({ onNavigate }) => {
  const { t } = useTranslation();
    const topics = [
        { page: 'learn/article/oven-spring', title: 'Oven Spring', description: 'The science of the initial dough expansion in the oven.', icon: <SignalIcon className="h-8 w-8" /> },
        ...
        { page: 'learn/article/sugars-enzymatic-activity', title: 'Sugars & Enzymes', description: 'How sugars, malts, and enzymes influence fermentation, color, and taste.', icon: <SignalIcon className="h-8 w-8" /> },
