...
const TomatoPreservationPage: React.FC = () => {
  return (
    ...
    >
      <LearnSection title="Introduction: The Acidic Soul of Pizza">
      ...
      <LearnSection title="Qualitative Differences: Raw vs. Cooked">
      ...
      <LearnSection title="How Acidity and Sweetness Influence Perception">
      ...
      <LearnSection title="Impact of Oxidation and Storage">
      ...
      <LearnSection title="Fresh Notes vs. Cooked Notes">
      ...
      <LearnSection title="Tomato Behavior in Baking">
