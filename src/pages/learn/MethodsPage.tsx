...
import { SunIcon, WrenchScrewdriverIcon, CubeIcon, SignalIcon, FireIcon, BeakerIcon, ShieldCheckIcon, ClockIcon } from '@/components/ui/Icons';
...
const MethodsPage: React.FC<MethodsPageProps> = ({ onNavigate }) => {
  const { t } = useTranslation();
    const topics = [
        ...
        { page: 'learn/article/sensory-maturation', title: 'Sensory Maturation', description: 'The formation of complex aromas in long fermentations.', icon: <SignalIcon className="h-8 w-8" /> },
