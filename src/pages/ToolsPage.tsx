            ...
            <div className="mx-auto max-w-7xl animate-fade-in pb-20">
                ...
                <div className="bg-gradient-to-br from-[#3A6B3A] to-[#558B55] rounded-3xl p-6 md:p-8 mb-8 shadow-2xl relative overflow-hidden mx-4 sm:mx-6">
                    ...
                    <div className="relative z-10 text-center max-w-3xl mx-auto">
                        ...
                        <p className="text-base md:text-lg text-lime-100/90 mb-4 leading-relaxed">{t('common:professional_grade_tools_for_diagnostics_analysis_and_optimi')}</p>
                        <p className="text-sm text-lime-200 font-medium">{t('common:unlock_pro_tools_for_advanced_oven_analytics_and_dough_diagn')}</p>
                    </div>
                </div>
                <div className="px-4 sm:px-6">
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {TOOLS.map((tool) => {
                            ...
                            if (tool.featureKey) {
                                return (
                                    <LockedTeaser key={tool.id} featureKey={tool.featureKey as FeatureKey}>
                                        {Card}
                                    </LockedTeaser>
                                );
                            }
