            ...
            <div className="relative aspect-[4/3] w-full bg-gray-100 overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/40 backdrop-blur-sm p-6 text-center">
                    <div className="bg-white p-4 rounded-full shadow-lg mb-4 ring-1 ring-black/5 animate-bounce-subtle">
                        <Lock className="h-6 w-6 text-dlp-primary-hover" />
                    </div>
                    ...
                    <button
                        ...
                        className="px-8 py-3 bg-dlp-primary-hover hover:bg-lime-700 text-white rounded-full font-bold transition-all shadow-lg hover:shadow-xl hover:scale-105 active:scale-95"
