    ...
    if (error) {
        return (
            <div className="text-center py-12 bg-red-50 rounded-2xl border border-red-100 p-8">
                ...
                <p className="text-red-900 font-bold mb-2">Unable to load feed</p>
    ...
    if (!loading && posts.length === 0) {
        return (
            <div className="text-center py-20 bg-gray-50/50 rounded-3xl border border-dashed border-gray-200">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">The oven is cold</h3>
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            {hasMore ? (
                <div className="text-center pt-8 pb-12">
                    ...
                    >
                        {loading ? (
                            ...
                            <>
                                <span className="font-medium text-sm">Load More Bakes</span>
                ...
                <div className="text-center py-12 text-gray-300">
                    ...
                    <p className="text-xs uppercase tracking-widest">End of Feed</p>
                </div>
            )}
        </div>
    );
