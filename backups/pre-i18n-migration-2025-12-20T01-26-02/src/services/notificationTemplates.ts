...
export const NOTIFICATION_TEMPLATES: Record<string, NotificationTemplate> = {
    ...
    neapolitan_fold_1: {
        ...
        bodyTemplate: 'Perform a gentle fold to strengthen the gluten network',
        requiresInteraction: false,
        vibrate: [200, 100, 200],
    ...
    croissant_detrempe: {
        ...
        bodyTemplate: 'Time to prepare butter block and begin lamination',
        requiresInteraction: false,
        defaultSchedule: { offsetMinutes: 60, relativeTo: 'start' },
    },
    croissant_fold_1: {
